...
export const GEAR: Record<GearType, GearDefinition> = {
  ...
  sprinkler_flame: {
    ...
    description:           "35% chance to apply Scorched to nearby blooms over 2 hours.",
    emoji:                 "🚿",
    rarity:                "legendary",
    shopPrice:             2_000,
  ...
  grow_lamp_uncommon: {
    ...
    name:            "Grow Lamp",
    description:     "Speeds up nearby plants by 1.3× during night periods.",
    emoji:           "💡",
    rarity:          "uncommon",
    shopPrice:       150,
    category:        "passive",
  ...
  scarecrow_rare: {
    id:             "scarecrow_rare",
    name:           "Scarecrow",
    description:    "Fully blocks weather mutations on nearby plants. Sprinkler mutations still apply.",
    emoji:          "🧹",
    rarity:         "rare",
    shopPrice:      800,
    category:       "passive",
  ...
  composter_uncommon: {
    ...
    name:           "Composter",
    description:    "Generates a fertilizer each time a nearby plant blooms. Stores up to 10.",
    emoji:          "🧺",
    rarity:         "uncommon",
    shopPrice:      300,
    category:       "passive",
