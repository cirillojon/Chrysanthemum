...
export const SUPPLY_POOLS: Partial<Record<Rarity, SupplyItem[]>> = {
  ...
  rare: [
    ...
    { kind: "consumable", consumableId: "magnifying_glass_1" },
    { kind: "consumable", consumableId: "garden_pin_1" },
  ...
  legendary: [
    ...
    { kind: "consumable", consumableId: "magnifying_glass_2" },
    { kind: "consumable", consumableId: "garden_pin_2" },
  ...
  mythic: [
    ...
    { kind: "consumable", consumableId: "magnifying_glass_3" },
    { kind: "consumable", consumableId: "garden_pin_3" },
